...
var GeolocationModule = function(rpcHandler, params) {
    ...
    if(process.platform == 'android') {
      ...
      console.log('************** android platform *************');
        ...
        try{
            var vehicleSystem = require(require("path").join(require.resolve('webinos-api-vehicle'), "contrib", "vb-con","vc.js"));
        ...
        try{
            car = require(require("path").join(require.resolve('webinos-api-vehicle'), "contrib", "vb-sim","vs.js"));
            implFile = 'sim';
        ...
        implFile = connector;
        console.log('connecting to '+implFile+' data provider');
    }
    ...
    try{
        ...
        console.log('ERROR: Failed to locate '+implFile+' data provider');
    }
